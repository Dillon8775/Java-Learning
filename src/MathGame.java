...
public class MathGame {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("You typed " + firstNumber);

        System.out.println("Now, choose your operator. +, -, * or /");
        operator = scanner.next();
        boolean isValid = operator.equals("+") || operator.equals("-") || operator.equals("*") || operator.equals("/");
        if (!isValid) {
            System.out.println("Hmm, looks like you didn't input a valid operator.");
            System.out.println("Closing program. Please try again.");
            exit();
        } else {
            System.out.println("You chose " + operator);
            System.out.println("Your current equation is: \"" + firstNumber + " " + operator + " ...\"");
        }

        System.out.println("Finally, choose your second number.");
        secondNumber = scanner.nextDouble();
        System.out.println("You typed " + secondNumber);
        System.out.println("Your equation is: \"" + firstNumber + " " + operator + " " + secondNumber + "\"");
        ...
        isValid = operator.equals("+") || operator.equals("-") || operator.equals("*") || operator.equals("/");
        operator = scanner.next();
        if (!isValid) {
            System.out.println("Hmm, looks like you didn't input a valid operator.");
            System.out.println("Closing program. Please try again.");
